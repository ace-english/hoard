...
public class MyGame extends VariableFrameRateGame implements MouseListener{
	...
	*/
    ...
    protected void setupScene(Engine eng, SceneManager sm) throws IOException {
    	...
    	state.setTexture(b1);
    	ball1Entity.setRenderState(state);
    	// Ball 2
    	...
    	ball2Entity.setRenderState(state);
			...
			if(playerType==PLAYER_TYPE.DRAGON) {
					if(x>0&&x<200) {
						...
						case 0:
							...
							break;
						case 1: 
							dungeon.addTrap(getCurrentRoom(), GameUtil.TRAP_TYPE.Swinging, physicsEng);
							break;
						case 2:
							dungeon.addTrap(getCurrentRoom(), GameUtil.TRAP_TYPE.Spike, physicsEng);
							break;
						case 3:
							dungeon.addTrap(getCurrentRoom(), GameUtil.TRAP_TYPE.Pit, physicsEng);
							break;
						case 4:
		...
		case BUILD:
	        ...
	        if(playerType==PLAYER_TYPE.KNIGHT) {
	        	...
	        	if(onlineType==ONLINE_TYPE.ONLINE) {
	            	...
	            	jsEngine.put("Swinging", GameUtil.TRAP_TYPE.Swinging);
	            	jsEngine.put("Pit", GameUtil.TRAP_TYPE.Pit);
	            	jsEngine.put("Spike", GameUtil.TRAP_TYPE.Spike);
	...
	public void buildDungeonFromString(String dngStr[]) {
		...
		for(int i=3; i<=roomNum+2; i++) {
			...
			switch(lines[i]) {
			case "Pit":
			System.out.println("adding room " + (i-3) + " with  " + lines[i]);
